...
from .serializers import FavoriteSerializer, BagSerializer, BagCreateSerializer, ProductSerializer
...
class BagCreateView(generics.CreateAPIView):
    queryset = Bag.objects.all()
    serializer_class = BagCreateSerializer
